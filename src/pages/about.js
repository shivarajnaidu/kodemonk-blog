        ...
        <div className="container">
          <div className="row">
            ...
            <section className="col-12 col-md-8 col-lg-9">
              <img className="img-fluid" alt="About me" loading="lazy" decoding="async" src="https://avatars.githubusercontent.com/u/12374494"></img>
              ...
              <p className="fst-italic text-muted about-me-content">
                ...
                in building scalable web/mobile applications and exploring new linux tech.
              </p>
              <p className="fst-italic text-muted about-me-content">
